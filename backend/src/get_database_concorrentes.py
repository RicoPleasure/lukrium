...
def get_data_from_api():
    ...
    "requests": [
        {
            "indexName": "Products",
            "params": "clickAnalytics=true&facets=%5B%22brand.slug%22%2C%22hierarchicalCategories.lvl0%22%2C%22product.hasPromotion%22%2C%22product.id%22%2C%22storeGroup%22%2C%22tags%22%5D&highlightPostTag=__%2Fais-highlight__&highlightPreTag=__ais-highlight__&hitsPerPage=34&maxValuesPerFacet=24&page=4&query=&tagFilters=&userToken=anonymous-e0cf968c-467c-443d-9280-a8b98388f043"
        }
    ]
    }
